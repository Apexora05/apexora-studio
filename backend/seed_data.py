...
# Page-intro documents (hero/section copy for the remaining marketing pages)
PAGE_DOCS = {
    "services": {
        "hero": {"eyebrow": "Services", "title": "Design and build, end to end.", "subtext": "A focused set of services covering every stage of your website — from first concept to continuous optimization."},
        "cta": {"eyebrow": "Not sure where to start?", "title": "Get a free website audit.", "text": "We'll review your current site and show you exactly where you're losing trust and revenue — no obligation.", "button": {"label": "Request Free Website Audit", "path": "/contact"}},
    },
    "portfolio": {
        "hero": {"eyebrow": "Selected Work", "title": "Work that earns attention.", "subtext": ""},
    },
    "case-studies": {
        "hero": {"eyebrow": "Case Studies", "title": "Proof, not promises.", "subtext": "A closer look at how strategy, design and engineering combine to move real business metrics."},
    },
    "blog": {
        "hero": {"eyebrow": "The Journal", "title": "Ideas on design that performs.", "subtext": ""},
    },
    "contact": {
        "hero": {"eyebrow": "Contact", "title": "Let's start something exceptional.", "subtext": "Tell us about your project. We reply to every enquiry within one business day."},
    },
    "privacy": {
    ...
    "terms": {
        "hero": {"eyebrow": "Legal", "title": "Terms & Conditions"},
...
async def seed_all():
    ...
    for pid, pdoc in PAGE_DOCS.items():
        if not await db.pages.find_one({"id": pid}):
            await db.pages.insert_one({"id": pid, **pdoc, "updated_at": _now()})
